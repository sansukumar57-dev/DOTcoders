		...
		<div className="flex flex-col items-center p-2 border rounded bg-white shadow-sm">
			...
			<div className="text-xs mt-1 text-center">
				<div className="flex gap-1 justify-center">
					{pattern.hasDownConnection && (
						<span className="px-1 py-0.5 bg-green-700 text-green-100 rounded text-[10px]">↓</span>
					)}
					{pattern.hasRightConnection && (
						<span className="px-1 py-0.5 bg-blue-700 text-blue-100 rounded text-[10px]">→</span>
					)}
					{!pattern.hasDownConnection && !pattern.hasRightConnection && (
						<span className="px-1 py-0.5 bg-gray-700 text-gray-100 rounded text-[10px]">·</span>
					)}
				</div>
			</div>
		</div>
